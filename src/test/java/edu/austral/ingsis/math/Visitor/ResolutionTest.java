...
public class ResolutionTest {
  ...
  public void shouldResolveSimpleFunction5() {
    final Double result =
        visitor.visit(new Power(new Number(36.0), new Div(new Number(1.0), new Number(2.0))));
  ...
  public void shouldResolveSimpleFunction8() {
    final Double result =
        visitor.visit(new Mult(new Sub(new Number(5.0), new Number(5.0)), new Number(8.0)));
